module Api::V1
  class PackagesController < ApplicationController
    ...
    before_action :set_includes, only: [:index, :show, :create]
    ...
    Authorization:  Token token=d03e8ea5848b038b911705bdcf9344d8
    ...
    ETag: W/"3d0701e6d42a43c4ccb9f85e4aaf50e5"
    Transfer-Encoding: chunked
    Vary: Origin
    X-Request-Id: 34d2475e-4027-4ead-91ea-62ea650440a6
    X-Runtime: 0.471462
        ...
        "data": [
            ...
            }, 
            {
                "crop": {
                    "crop_logs": [
                        {
                            "created_at": "2017-05-29T01:50:58.761Z", 
                            "description": "We have applied pesticides", 
                            "id": 4
                        }, 
                        {
    ...
    def index
      ...
      json_response(@packages, :ok, @includes)
    end
    ...
    def show
      if @package
        json_response(@package, :ok, @includes)
      else
    ...
    EOM
    def create
      json_response(current_user.packages.create!(package_params, request), :created, @includes)
    end
    ...
    def set_includes
      @includes = %w(crop crop.container crop.product crop.crop_logs route route.route_logs)
    end
  end
end